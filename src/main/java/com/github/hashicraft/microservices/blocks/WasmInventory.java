 ...
 * Originally by Juuz
 */
public interface WasmInventory extends Inventory {

  static final Logger LOGGER = LoggerFactory.getLogger(WasmBlock.class);
  ...
  void executeWasmFunction(String requestID, String data);

  /**
   * Creates an inventory from the item list.
   */
  // static DatabaseInventory of(DefaultedList<ItemStack> items) {
  // return () -> items;
  // }
   ...
   */
  // static DatabaseInventory ofSize(int size) {
